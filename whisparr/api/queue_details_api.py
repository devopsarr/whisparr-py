...
class QueueDetailsApi(object):
    ...
    @validate_arguments
    def list_queue_details(self, movie_id : Optional[StrictInt] = None, include_movie : Optional[StrictBool] = None, **kwargs) -> List[QueueResource]:  # noqa: E501
        """list_queue_details  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_queue_details(movie_id, include_movie, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_queue_details_with_http_info(movie_id, include_movie, **kwargs)  # noqa: E501

    @validate_arguments
    def list_queue_details_with_http_info(self, movie_id : Optional[StrictInt] = None, include_movie : Optional[StrictBool] = None, **kwargs):  # noqa: E501
        """list_queue_details  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_queue_details_with_http_info(movie_id, include_movie, async_req=True)
        >>> result = thread.get()
