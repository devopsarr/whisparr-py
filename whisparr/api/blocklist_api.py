...
class BlocklistApi(object):
    ...
    @validate_arguments
    def list_blocklist_movie(self, movie_id : Optional[StrictInt] = None, **kwargs) -> List[BlocklistResource]:  # noqa: E501
        """list_blocklist_movie  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_blocklist_movie(movie_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: List[BlocklistResource]
        """
        kwargs['_return_http_data_only'] = True
        return self.list_blocklist_movie_with_http_info(movie_id, **kwargs)  # noqa: E501

    @validate_arguments
    def list_blocklist_movie_with_http_info(self, movie_id : Optional[StrictInt] = None, **kwargs):  # noqa: E501
        """list_blocklist_movie  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_blocklist_movie_with_http_info(movie_id, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(List[BlocklistResource], status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_blocklist_movie" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "List[BlocklistResource]",
        }

        return self.api_client.call_api(
            '/api/v3/blocklist/movie', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
