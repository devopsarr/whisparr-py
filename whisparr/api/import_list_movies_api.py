...
class ImportListMoviesApi(object):
    ...
    def create_importlist_movie(self, movie_resource : Optional[conlist(MovieResource)] = None, **kwargs) -> None:  # noqa: E501
        ...
        >>> thread = api.create_importlist_movie(movie_resource, async_req=True)
        >>> result = thread.get()
    ...
    def create_importlist_movie_with_http_info(self, movie_resource : Optional[conlist(MovieResource)] = None, **kwargs):  # noqa: E501
        ...
        >>> thread = api.create_importlist_movie_with_http_info(movie_resource, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_importlist_movie" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def get_importlist_movie_with_http_info(self, include_recommendations : Optional[StrictBool] = None, **kwargs):  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_importlist_movie" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
