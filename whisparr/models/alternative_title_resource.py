...
class AlternativeTitleResource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AlternativeTitleResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AlternativeTitleResource:
        """Create an instance of AlternativeTitleResource from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AlternativeTitleResource.parse_obj(obj)

        _obj = AlternativeTitleResource.parse_obj({
            "id": obj.get("id"),
