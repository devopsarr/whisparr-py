...
class UiConfigResource(BaseModel):
    ...
    __properties = ["id", "firstDayOfWeek", "calendarWeekColumnHeader", "movieRuntimeFormat", "shortDateFormat", "longDateFormat", "timeFormat", "showRelativeDates", "enableColorImpairedMode", "movieInfoLanguage", "uiLanguage"]
