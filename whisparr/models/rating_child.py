...
class RatingChild(BaseModel):
    ...
    type: Optional[RatingType]
    __properties = ["votes", "value", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RatingChild:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RatingChild:
        """Create an instance of RatingChild from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return RatingChild.parse_obj(obj)

        _obj = RatingChild.parse_obj({
            "votes": obj.get("votes"),
            "value": obj.get("value"),
            "type": obj.get("type")
        })
