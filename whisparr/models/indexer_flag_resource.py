...
class IndexerFlagResource(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IndexerFlagResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IndexerFlagResource:
        """Create an instance of IndexerFlagResource from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return IndexerFlagResource.parse_obj(obj)

        _obj = IndexerFlagResource.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
