...
class MetadataConfigResource(BaseModel):
    ...
    certification_country: Optional[TMDbCountryCode] = Field(default=None, alias="certificationCountry")
    __properties: ClassVar[List[str]] = ["id", "certificationCountry"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "certificationCountry": obj.get("certificationCountry")
        })
        return _obj
