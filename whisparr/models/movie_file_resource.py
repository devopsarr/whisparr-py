...
class MovieFileResource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "movieId", "relativePath", "path", "size", "dateAdded", "sceneName", "indexerFlags", "quality", "customFormats", "customFormatScore", "mediaInfo", "originalFilePath", "qualityCutoffNotMet", "languages", "releaseGroup", "edition"]
