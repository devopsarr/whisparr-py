...
class ImportExclusionsResource(BaseModel):
    ...
    presets: Optional[List[ImportExclusionsResource]] = None
    ...
    movie_year: Optional[StrictInt] = Field(default=None, alias="movieYear")
    __properties: ClassVar[List[str]] = ["id", "name", "fields", "implementationName", "implementation", "configContract", "infoLink", "message", "tags", "presets", "tmdbId", "movieTitle", "movieYear"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "presets": [ImportExclusionsResource.from_dict(_item) for _item in obj["presets"]] if obj.get("presets") is not None else None,
            "tmdbId": obj.get("tmdbId"),
            "movieTitle": obj.get("movieTitle"),
            "movieYear": obj.get("movieYear")
        })
        return _obj

# TODO: Rewrite to not use raise_errors
ImportExclusionsResource.model_rebuild(raise_errors=False)
