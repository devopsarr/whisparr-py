...
class MovieStatisticsResource(BaseModel):
    ...
    """
    movie_file_count: Optional[int]
    size_on_disk: Optional[int]
    release_groups: Optional[List]
    __properties = ["movieFileCount", "sizeOnDisk", "releaseGroups"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MovieStatisticsResource:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MovieStatisticsResource:
        """Create an instance of MovieStatisticsResource from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return MovieStatisticsResource.parse_obj(obj)

        _obj = MovieStatisticsResource.parse_obj({
            "movie_file_count": obj.get("movieFileCount"),
