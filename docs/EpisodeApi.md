...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.EpisodeApi(api_client)
    id = 56 # int | 
...
with whisparr.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = whisparr.EpisodeApi(api_client)
    episodes_monitored_resource = whisparr.EpisodesMonitoredResource() # EpisodesMonitoredResource |  (optional)
...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.EpisodeApi(api_client)
    id = 56 # int | 
    episode_resource = whisparr.EpisodeResource() # EpisodeResource |  (optional)
