...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.ImportListConfigApi(api_client)
...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.ImportListConfigApi(api_client)
    id = 'id_example' # str | 
    import_list_config_resource = whisparr.ImportListConfigResource() # ImportListConfigResource |  (optional)
