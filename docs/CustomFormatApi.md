...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.CustomFormatApi(api_client)
    custom_format_resource = whisparr.CustomFormatResource() # CustomFormatResource |  (optional)
