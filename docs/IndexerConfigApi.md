...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.IndexerConfigApi(api_client)
...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.IndexerConfigApi(api_client)
    id = 'id_example' # str | 
    indexer_config_resource = whisparr.IndexerConfigResource() # IndexerConfigResource |  (optional)
