...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.LanguageProfileApi(api_client)
    language_profile_resource = whisparr.LanguageProfileResource() # LanguageProfileResource |  (optional)
