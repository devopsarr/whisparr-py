...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.RemotePathMappingApi(api_client)
    remote_path_mapping_resource = whisparr.RemotePathMappingResource() # RemotePathMappingResource |  (optional)
