...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.BlocklistApi(api_client)
    id = 56 # int | 
...
with whisparr.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = whisparr.BlocklistApi(api_client)
    blocklist_bulk_resource = whisparr.BlocklistBulkResource() # BlocklistBulkResource |  (optional)
