...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.MetadataConfigApi(api_client)
...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.MetadataConfigApi(api_client)
    id = 'id_example' # str | 
    metadata_config_resource = whisparr.MetadataConfigResource() # MetadataConfigResource |  (optional)
