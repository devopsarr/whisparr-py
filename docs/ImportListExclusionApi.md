# whisparr.ImportListExclusionApi
...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.ImportListExclusionApi(api_client)
    import_list_exclusion_resource = whisparr.ImportListExclusionResource() # ImportListExclusionResource |  (optional)
