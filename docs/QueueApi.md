...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.QueueApi(api_client)
    id = 56 # int | 
...
with whisparr.ApiClient(configuration) as api_client:
    ...
    skip_redownload = False # bool |  (optional) (default to False)
    change_category = False # bool |  (optional) (default to False)
    queue_bulk_resource = whisparr.QueueBulkResource() # QueueBulkResource |  (optional)
...
with whisparr.ApiClient(configuration) as api_client:
    ...
    protocol = whisparr.DownloadProtocol() # DownloadProtocol |  (optional)
