...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.SeriesEditorApi(api_client)
    series_editor_resource = whisparr.SeriesEditorResource() # SeriesEditorResource |  (optional)
