...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.ReleaseProfileApi(api_client)
    release_profile_resource = whisparr.ReleaseProfileResource() # ReleaseProfileResource |  (optional)
