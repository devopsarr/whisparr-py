...
[**list_credit**](CreditApi.md#list_credit) | **GET** /api/v3/credit | 
...
# **list_credit**
> List[CreditResource] list_credit(movie_id=movie_id, movie_metadata_id=movie_metadata_id)
...
with whisparr.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.list_credit(movie_id=movie_id, movie_metadata_id=movie_metadata_id)
        print("The response of CreditApi->list_credit:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CreditApi->list_credit: %s\n" % e)
```
...
[**List[CreditResource]**](CreditResource.md)
