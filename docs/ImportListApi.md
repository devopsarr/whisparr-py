...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.ImportListApi(api_client)
    force_save = False # bool |  (optional) (default to False)
    import_list_resource = whisparr.ImportListResource() # ImportListResource |  (optional)
...
with whisparr.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = whisparr.ImportListApi(api_client)
    import_list_bulk_resource = whisparr.ImportListBulkResource() # ImportListBulkResource |  (optional)
