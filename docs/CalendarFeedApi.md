...
> get_feed_v3_calendar_whisparr_ics(past_days=past_days, future_days=future_days, tag_list=tag_list, unmonitored=unmonitored)
...
with whisparr.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.get_feed_v3_calendar_whisparr_ics(past_days=past_days, future_days=future_days, tag_list=tag_list, unmonitored=unmonitored)
