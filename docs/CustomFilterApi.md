...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.CustomFilterApi(api_client)
    custom_filter_resource = whisparr.CustomFilterResource() # CustomFilterResource |  (optional)
