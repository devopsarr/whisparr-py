...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.MovieFileApi(api_client)
    id = 56 # int | 
...
with whisparr.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = whisparr.MovieFileApi(api_client)
    movie_file_list_resource = whisparr.MovieFileListResource() # MovieFileListResource |  (optional)
...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.MovieFileApi(api_client)
    id = 'id_example' # str | 
    movie_file_resource = whisparr.MovieFileResource() # MovieFileResource |  (optional)
