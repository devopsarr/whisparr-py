...
with whisparr.ApiClient(configuration) as api_client:
    ...
    api_instance = whisparr.NotificationApi(api_client)
    force_save = False # bool |  (optional) (default to False)
    notification_resource = whisparr.NotificationResource() # NotificationResource |  (optional)
...
with whisparr.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = whisparr.NotificationApi(api_client)
    notification_bulk_resource = whisparr.NotificationBulkResource() # NotificationBulkResource |  (optional)
